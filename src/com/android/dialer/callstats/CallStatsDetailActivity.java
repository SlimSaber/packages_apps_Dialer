...
public class CallStatsDetailActivity extends Activity {
    ...
    private void updateData() {
        ...
        if (totalDuration != 0) {
            ...
            updateBar(mDurationBar, mData.inDuration, mData.outDuration, 0, totalDuration);
            updateBar(mTotalDurationBar, mData.inDuration, mData.outDuration,
                    0, mTotalData.getFullDuration());
        ...
        updateBar(mCountBar, mData.incomingCount, mData.outgoingCount,
                mData.missedCount, totalCount);
        updateBar(mTotalCountBar, mData.incomingCount, mData.outgoingCount,
                mData.missedCount, mTotalData.getTotalCount());
    }
    ...
    private void updateBar(LinearColorBar bar,
            long value1, long value2, long value3, long total) {
